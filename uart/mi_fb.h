...
　* @return void 
 */
void MI_fb_fb_memcpy(void *addr,void *color,size_t len);
 ...
 */
RGBT MI_fb_getRGBT(const char *color);
 ...
 *
 */
void MI_fb_draw_x_y_color_dot_with_string(PFBDEV pFbdev,int x,int y,const char *color);
